...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run Phase7U citation guard smoke.")
    ...
    summary = run_citation_guard_smoke(fixture_path=args.fixture_path, output_dir=args.output_dir)
