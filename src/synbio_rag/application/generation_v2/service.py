...
from .limited_support import (
    _build_limited_support_pack,
    _extract_matched_entities,
...
class GenerationV2Service:
    ...
    def run(
        ...
        build_params = inspect.signature(self.answer_builder.build).parameters
        if "config" in build_params:
